# PR-11: docs(proposal): add C/C++ architecture decision record

## Scope
This branch contains the dedicated workstream for PR-11 under the C/C++ + OpenSSL mentorship track.
