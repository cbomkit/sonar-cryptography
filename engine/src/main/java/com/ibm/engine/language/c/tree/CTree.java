...
/**
 * Base interface for C/C++ AST nodes used in the detection engine.
 *
 * <p>Implementations of this interface wrap parser-generated tree nodes and expose only the
 * information needed by the detection engine. This keeps the engine free of parser-specific
 * dependencies.
 */
