...
@Rule(key = "Inventory")
public class JavaScriptInventoryRule extends JavaScriptBaseDetectionRule {

    public JavaScriptInventoryRule() {
        super(true, JavaScriptDetectionRules.rules(), JavaScriptReorganizerRules.rules());
    }

    @VisibleForTesting
    protected JavaScriptInventoryRule(@Nonnull List<IDetectionRule<Tree>> detectionRules) {
        super(true, detectionRules, JavaScriptReorganizerRules.rules());
    }
