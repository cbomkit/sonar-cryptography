...
/** Detection rules for methods on Node.js {@code crypto.Verify} objects. */
@SuppressWarnings("java:S1192")
public final class NodeCryptoVerifyStream {

    private NodeCryptoVerifyStream() {
        // private
    }
    ...
    private static final IDetectionRule<Tree> UPDATE =
            new DetectionRuleBuilder<Tree>()
                    .createDetectionRule()
                    .forObjectTypes(NodeCryptoTypes.VERIFY)
                    .forMethods("update")
    ...
    private static final Supplier<List<IDetectionRule<Tree>>> RULES =
            Memoize.of(NodeCryptoVerifyStream::buildRules);
