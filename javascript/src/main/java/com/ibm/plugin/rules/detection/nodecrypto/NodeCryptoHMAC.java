...
/**
 * Detection rules for Node.js {@code crypto.createHmac()}.
 *
 * <p>Detects usage of:
 *
 * <ul>
 *   <li>crypto.createHmac(algorithm, key) - creates an HMAC stream
 * </ul>
 */
@SuppressWarnings("java:S1192")
public final class NodeCryptoHMAC {

    private NodeCryptoHMAC() {
        // private
    }

    private static final IDetectionRule<Tree> CREATE_HMAC =
            new DetectionRuleBuilder<Tree>()
                    ...
                    .withDependingDetectionRules(NodeCryptoHmacStream.rules());

    private static final Supplier<List<IDetectionRule<Tree>>> RULES =
            Memoize.of(NodeCryptoHMAC::buildRules);
