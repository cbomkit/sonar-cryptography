...
/** Reorganizer rules for Node.js crypto detections (same mapper rules as Go). */
public final class JavaScriptReorganizerRules {

    private JavaScriptReorganizerRules() {
        // utility
    }
