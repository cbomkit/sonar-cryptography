...
public final class BcKyberParameters {

    private BcKyberParameters() {
        // nothing
    }

    // deprecated since bc 1.79
    ...
    private static final IDetectionRule<Tree> PUBLIC_KEY_CONSTRUCTOR =
            new DetectionRuleBuilder<Tree>()
                    .createDetectionRule()
                    .forObjectTypes(
                            "org.bouncycastle.pqc.crypto.crystals.kyber.KyberPublicKeyParameters")
                    .forConstructor()
                    .withMethodParameter(
                            "org.bouncycastle.pqc.crypto.crystals.kyber.KyberParameters")
                    .shouldBeDetectedAs(
