...
public final class BcNTRUParameters {

    private BcNTRUParameters() {
        // nothing
    }
    ...
    private static final IDetectionRule<Tree> PRIVATE_KEY_CONSTRUCTOR =
            new DetectionRuleBuilder<Tree>()
                    .createDetectionRule()
                    .forObjectTypes("org.bouncycastle.pqc.crypto.ntru.NTRUPrivateKeyParameters")
                    .forConstructor()
                    .withMethodParameter("org.bouncycastle.pqc.crypto.ntru.NTRUParameters")
                    .shouldBeDetectedAs(
    ...
    private static final IDetectionRule<Tree> PUBLIC_KEY_CONSTRUCTOR =
            new DetectionRuleBuilder<Tree>()
                    .createDetectionRule()
                    .forObjectTypes("org.bouncycastle.pqc.crypto.ntru.NTRUPublicKeyParameters")
                    .forConstructor()
                    .withMethodParameter("org.bouncycastle.pqc.crypto.ntru.NTRUParameters")
                    .shouldBeDetectedAs(
                            new AlgorithmParameterFactory<>(AlgorithmParameter.Kind.ANY))
    ...
    public static List<IDetectionRule<Tree>> rules() {
        return List.of(PRIVATE_KEY_CONSTRUCTOR, PUBLIC_KEY_CONSTRUCTOR);
    }
}
