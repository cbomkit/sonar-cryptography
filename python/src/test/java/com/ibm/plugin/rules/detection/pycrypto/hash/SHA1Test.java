...
public class SHA1Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/hash/SHA1TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(value.asString()).isEqualTo("SHA1");
        ...
        assertThat(oid.asString()).isEqualTo("1.3.14.3.2.26");
