...
public class HKDFTest extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/kdf/HKDFTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(value.asString()).isEqualTo("HKDF");
        ...
        assertThat(root).isInstanceOf(HKDF.class);
        assertThat(root.getChildren()).hasSize(3);
        assertThat(root.asString()).isEqualTo("HKDF-SHA-512");
