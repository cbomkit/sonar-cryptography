...
public class RSATest extends TestBase {
    ...
    public RSATest() {
        super(PythonCryptoPublicKey.RSARules());
    }

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/publickey/RSATestFile.py", this);
    }
    ...
    public void asserts(
        ...
        switch (findingId) {
            case 0 -> {
                ...
                assertThat(root.asString()).isEqualTo("RSA");
            ...
            case 1 -> {
                ...
                IValue<Tree> kAction = detectionStore.getDetectionValues().get(0);
                assertThat(kAction).isInstanceOf(KeyAction.class);
                assertThat(((KeyAction<Tree>) kAction).getAction())
