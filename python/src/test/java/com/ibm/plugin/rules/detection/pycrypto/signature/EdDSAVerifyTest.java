...
public class EdDSAVerifyTest extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/signature/EdDSAVerifyTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        if (findingId == 2) {
            ...
            assertThat(value.asString()).isEqualTo("EDDSA");
            ...
            assertThat(sig.getChildren()).hasSize(3);
            assertThat(sig.asString()).isEqualTo("EdDSA");

            INode key = sig.getChildren().get(Key.class);
            assertThat(key).isNotNull();
            assertThat(key.asString()).isEqualTo("EC");
            ...
            assertThat(pke.getChildren().get(Oid.class).asString()).isEqualTo("1.2.840.10045.2.1");
            ...
            assertThat(mdOid.asString()).isEqualTo("2.16.840.1.101.3.4.2.3");
            ...
            INode verify = sig.getChildren().get(Verify.class);
