...
public class KMAC128Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/mac/KMAC128TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(value.asString()).isEqualTo("KMAC128");
        ...
        assertThat(mac.asString()).isEqualTo("KMAC128");
        ...
        assertThat(cshake.asString()).isEqualTo("cSHAKE128");
