...
public class Poly1305Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/mac/Poly1305TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(value.asString()).isEqualTo("Poly1305");
        ...
        assertThat(mac.asString()).isEqualTo("Poly1305");
