 ...
 */
package com.ibm.plugin.rules.detection.pyca.asymmetric.DiffieHellman;
...
public final class PycaDiffieHellmanGenerateTest extends TestBase {
    ...
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pyca/asymmetric/DiffieHellman/PycaDiffieHellmanGenerateTestFile.py",
                this);
    }
