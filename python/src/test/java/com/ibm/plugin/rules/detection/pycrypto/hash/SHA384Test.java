...
public class SHA384Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/hash/SHA384TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(oid.asString()).isEqualTo("2.16.840.1.101.3.4.2.2");
