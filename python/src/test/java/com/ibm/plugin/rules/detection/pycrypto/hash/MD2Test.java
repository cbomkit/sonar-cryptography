...
public class MD2Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/hash/MD2TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(md.getChildren()).hasSize(3);
        assertThat(md.asString()).isEqualTo("MD2");
