...
public class CMACTest extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/mac/CMACTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(mac.asString()).isEqualTo("CMAC-AES");
        assertThat(mac.getChildren()).hasSize(2);

        INode cipher = mac.getChildren().get(BlockCipher.class);
        assertThat(cipher).isNotNull();
        assertThat(cipher.asString()).isEqualTo("AES");
