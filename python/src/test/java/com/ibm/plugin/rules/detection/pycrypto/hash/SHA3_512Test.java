...
public class SHA3_512Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/hash/SHA3_512TestFile.py", this);
    }
