...
public class BLAKE2sTest extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/hash/BLAKE2sTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(saltLength.asString()).isEqualTo("64");
