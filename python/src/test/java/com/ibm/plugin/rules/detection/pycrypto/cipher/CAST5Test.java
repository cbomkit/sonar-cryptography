...
public class CAST5Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/cipher/CAST5TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(value.asString()).isEqualTo("CAST5");
        ...
        assertThat(cipher.asString()).isEqualTo("CAST5-CBC");
