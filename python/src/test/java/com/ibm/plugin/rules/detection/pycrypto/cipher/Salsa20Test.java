...
public class Salsa20Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/cipher/Salsa20TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(value.asString()).isEqualTo("Salsa20");
        ...
        assertThat(cipher.getKind()).isEqualTo(StreamCipher.class);
        assertThat(cipher.getChildren()).hasSize(1);
        assertThat(cipher.asString()).isEqualTo("Salsa20");

        INode keyLength = cipher.getChildren().get(KeyLength.class);
        assertThat(keyLength).isNotNull();
        assertThat(keyLength.getChildren()).isEmpty();
