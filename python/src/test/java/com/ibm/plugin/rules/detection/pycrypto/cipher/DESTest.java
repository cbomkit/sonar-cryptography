...
public class DESTest extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/cipher/DESTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(modeStore.getDetectionValues().get(0).asString()).isEqualTo("MODE_ECB");
        ...
        assertThat(cipher.asString()).isEqualTo("DES-56-ECB");
