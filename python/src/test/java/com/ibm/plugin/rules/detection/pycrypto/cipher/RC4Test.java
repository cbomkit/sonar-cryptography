...
public class RC4Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/cipher/RC4TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(value.asString()).isEqualTo("RC4");
        ...
        assertThat(cipher.asString()).isEqualTo("RC4");
    }
}
