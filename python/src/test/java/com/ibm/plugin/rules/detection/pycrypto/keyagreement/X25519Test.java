...
public class X25519Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/keyagreement/X25519TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        if (findingId == 1) {
            ...
            assertThat(root).isInstanceOf(X25519.class);
            assertThat(root.asString()).isEqualTo("x25519");

            assertThat(root.getChildren().get(Oid.class)).isNotNull();
            assertThat(root.getChildren().get(Oid.class).asString()).isEqualTo("1.3.101.110");
            ...
            assertThat(root.getChildren().get(PublicKey.class).asString())
                    .isEqualTo("EC-Curve25519");
