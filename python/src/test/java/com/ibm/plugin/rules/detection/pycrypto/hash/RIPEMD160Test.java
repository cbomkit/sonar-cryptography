...
public class RIPEMD160Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/hash/RIPEMD160TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(md.asString()).isEqualTo("RIPEMD-160");
