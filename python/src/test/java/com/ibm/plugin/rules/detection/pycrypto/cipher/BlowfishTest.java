...
public class BlowfishTest extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/cipher/BlowfishTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(value.asString()).isEqualTo("Blowfish");
        ...
        assertThat(cipher.asString()).isEqualTo("Blowfish-CBC");
