 ...
 */
package com.ibm.plugin.rules.detection.pyca.symmetric;
...
class PycaCipher3Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pyca/symmetric/PycaCipher3TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(blockCipherNode.asString()).isEqualTo("AES-CBC");
