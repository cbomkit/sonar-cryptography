...
public class SHA3_256Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/hash/SHA3_256TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(value.asString()).isEqualTo("SHA3_256");
        ...
        assertThat(blockSize.asString()).isEqualTo("1088");

        INode oid = md.getChildren().get(Oid.class);
        assertThat(oid).isNotNull();
        assertThat(oid.getChildren()).isEmpty();
        assertThat(oid.asString()).isEqualTo("2.16.840.1.101.3.4.2.8");
