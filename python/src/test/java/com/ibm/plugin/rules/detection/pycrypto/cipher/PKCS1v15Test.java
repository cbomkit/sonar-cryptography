...
public class PKCS1v15Test extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/cipher/PKCS1v15TestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(value.asString()).isEqualTo("PKCS1_v1_5");
        ...
        assertThat(cipher.getChildren()).hasSize(2);
        assertThat(cipher.asString()).isEqualTo("RSA");
