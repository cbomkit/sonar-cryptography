...
class PycaEllipticCurveSignTest extends TestBase {
    ...
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pyca/asymmetric/EllipticCurve/PycaEllipticCurveSignTestFile.py",
                this);
    }
    ...
    public void asserts(
        ...
        assertThat(signatureNode.asString()).isEqualTo("ECDSA-secp384r1-SHA3-512");
