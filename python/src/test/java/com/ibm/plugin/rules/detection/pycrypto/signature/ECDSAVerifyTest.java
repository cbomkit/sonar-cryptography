...
public class ECDSAVerifyTest extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/signature/ECDSAVerifyTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        if (findingId == 2) {
            ...
            assertThat(sig.asString()).isEqualTo("ECDSA-SHA-256");

            INode oid = sig.getChildren().get(Oid.class);
            assertThat(oid).isNotNull();
            assertThat(oid.getChildren()).isEmpty();
            assertThat(oid.asString()).isEqualTo("1.2.840.10045.4.3.2");
