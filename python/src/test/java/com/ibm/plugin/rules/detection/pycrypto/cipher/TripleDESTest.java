...
public class TripleDESTest extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/cipher/TripleDESTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        assertThat(cipher.asString()).isEqualTo("3DES-CBC");
