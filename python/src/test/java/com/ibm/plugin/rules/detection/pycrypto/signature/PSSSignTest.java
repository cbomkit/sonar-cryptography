...
public class PSSSignTest extends TestBase {

    @Test
    void test() {
        PythonCheckVerifier.verify(
                "src/test/files/rules/detection/pycrypto/signature/PSSSignTestFile.py", this);
    }
    ...
    public void asserts(
        ...
        if (findingId == 2) {
            ...
            INode sign = pss.getChildren().get(Sign.class);
