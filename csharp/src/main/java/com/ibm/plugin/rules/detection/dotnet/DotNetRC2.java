 ...
 *
 * <ul>
 *   <li>{@code RC2.Create()} — abstract factory (weak cipher)
 *   <li>{@code new RC2CryptoServiceProvider()} — CAPI-backed (weak cipher)
 * </ul>
 */
@SuppressWarnings("java:S1192")
public final class DotNetRC2 extends DetectionRuleSet<CSharpTree> {
